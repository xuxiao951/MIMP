...
public class ReflashListView extends ListView  implements OnScrollListener{
	...
	public ReflashListView(Context pContext, AttributeSet pAttrs) {
		super(pContext, pAttrs);
		init(pContext);
	}

	public ReflashListView(Context pContext) {
		super(pContext);
		init(pContext);
	}

	public ReflashListView(Context pContext, AttributeSet pAttrs, int pDefStyle) {
	...
	private void addHeadView() {
		mHeadView = mInflater.inflate(R.layout.xlistview_header, null);
		...
		mTipsTextView = (TextView) mHeadView.findViewById(
				R.id.xlistview_header_hint_textview);
	...
	private void addFooterView() {
		...
		mEndLoadTipsTextView = (TextView) mEndRootView.findViewById(R.id.xlistview_footer_hint_textview);
	...
	private void  changeEndViewByState() {
		if (mCanLoadMore) {
			...
			case ENDINT_LOADING://刷新中
				...
				mEndLoadTipsTextView.setText(R.string.xlistview_footer_hint_loading);
			...
			case ENDINT_MANUAL_LOAD_DONE:// 手动刷新完成
				...
				// 点击加载
				mEndLoadTipsTextView.setText(R.string.xlistview_footer_hint_normal);
				mEndLoadTipsTextView.setVisibility(View.VISIBLE);
			...
			case ENDINT_AUTO_LOAD_DONE:// 自动刷新完成
				...
				// 更    多
				mEndLoadTipsTextView.setText(R.string.xlistview_footer_hint_ready);
				mEndLoadTipsTextView.setVisibility(View.VISIBLE);
				mEndLoadProgressBar.setVisibility(View.GONE);
...
//				}
	...
	private void changeHeaderViewByState() {
		...
		case RELEASE_TO_REFRESH:
			...
			// 松开刷新
			mTipsTextView.setText(R.string.xlistview_header_hint_ready);
		...
		case PULL_TO_REFRESH:
			...
			if (mIsBack) {
				...
				// 下拉刷新
				mTipsTextView.setText(R.string.xlistview_header_hint_normal);
			} else {
				// 下拉刷新
				mTipsTextView.setText(R.string.xlistview_header_hint_normal);
			}
		...
		case REFRESHING:
			...
			// 正在刷新...
			mTipsTextView.setText(R.string.xlistview_header_hint_loading);
			mLastUpdatedTextView.setVisibility(View.VISIBLE);
...
//				getResources().getString(R.string.xlistview_header_last_time) + 
				new SimpleDateFormat(DATE_FORMAT_STR, Locale.CHINA).format(new Date(System.currentTimeMillis())));
		changeHeaderViewByState();
	}
